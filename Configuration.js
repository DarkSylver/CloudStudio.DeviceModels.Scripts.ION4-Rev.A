...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  // endpoints.addEndpoint("2", "CO2 sensor", endpointType.ppmConcentrationSensor, ppmConcentrationSensorSubType.carbonDioxide);
    ...
    /*var e = endpoints.addEndpoint("Ia", "Corriente A", endpointType.genericSensor);
    e.variableTypeId = 1015;
    var e = endpoints.addEndpoint("Ib", "Corriente B", endpointType.genericSensor);
    e.variableTypeId = 1015;
    var e = endpoints.addEndpoint("Ic", "Corriente C", endpointType.genericSensor);
    e.variableTypeId = 1015;*/

    endpoints.addEndpoint("Ia", "Corriente A", endpointType.currentSensor);
    endpoints.addEndpoint("Ib", "Corriente B", endpointType.currentSensor);
    endpoints.addEndpoint("Ic", "Corriente C", endpointType.currentSensor);
    endpoints.addEndpoint("V_LL_Avg", "Tension Linea Promedio", endpointType.voltageSensor );
    //endpoints.addEndpoint("Etot", "Energia Total", endpointType.energyMeter  );
    endpoints.addEndpoint("PAtot", "Potencia Activa Total", endpointType.activePowerSensor);
    endpoints.addEndpoint("Cos", "Factor de Potencia", endpointType.cosPhiSensor);

  var e = endpoints.addEndpoint("EnergActTot", "Energia Activa Total", endpointType.genericSensor );
