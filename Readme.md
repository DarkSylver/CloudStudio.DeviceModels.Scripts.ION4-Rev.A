...
# Parsing + Configuration Script – ION4 - Rev. A

This **Parsing + Configuration** script is designed for the **ION4** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – ION4 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **ION4** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
